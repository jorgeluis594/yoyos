...
function dependencies(prior: string | null): RecordMessageDependencies {
  return {
    ensureContact: vi.fn(async () => ({ success: true as const, data: { id: "2e98e108-1821-4fd1-a507-21e3e00b76f1" } })),
    chats: {
      findMessageId: vi.fn(async () => ({ success: true as const, data: prior })),
      ensureChat: vi.fn(async () => ({ success: true as const, data: { id: "5b47b1ef-5d21-4c0b-9c53-3db6e5634b19" } })),
