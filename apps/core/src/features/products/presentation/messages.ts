...
function message(issue: ValidationIssue): string {
  const label = { name: "nombre", description: "descripción", sku: "SKU", salePrice: "precio de venta", purchasePrice: "precio de compra", initialStock: "stock inicial", currency: "moneda", imageId: "imagen", variants: "variantes", attributes: "atributos" }[issue.field];
  const subject = { name: "El nombre", description: "La descripción", sku: "El SKU", salePrice: "El precio de venta", purchasePrice: "El precio de compra", initialStock: "El stock inicial", currency: "La moneda", imageId: "La imagen", variants: "Las variantes", attributes: "Los atributos" }[issue.field];
  switch (issue.reason) {
